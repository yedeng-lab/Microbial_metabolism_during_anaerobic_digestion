...
moteam=function (data,n.majority=5,threshold=0.6,p_adj_method="none",min_occur=10,method="mic",n_expansion=1000000,used_p=0.05,only_generate_cor=FALSE){
  output=list()
  #step 1 majority
  ...
  if (!only_generate_cor) {
    ...
    obtain_table2=trans_table_s[trans_table_s$adjust_pvalue<used_p,1]#adjusted p value < 0.05
